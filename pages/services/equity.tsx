    ...
    <div>
      ...
      <div className="servicecard">
        <div>
          ...
          <div>
            <h2 className="pagesubtitle">Make Financial Markets work for you with MegaCapital Traders Broking’s Online Equity Trading</h2>
            <ul className="pagetext">
              ...
              <li>MegaCapital Broking simplifies your Equity Investment & Trading Experience in both the major exchanges i.e. NSE & BSE</li>
            </ul>
          </div>
          <div>
            <h2 className="pagesubtitle">
              Stock Market Investments with MegaCapital Traders Broking
            </h2>

            <p className="pagetext">MegaCapital Broking, as a registered broker with NSE & BSE provides you with a Demat Account for investing in long-term Equities or trading in Equities as per your objectives and preferences. The Online Equity Trading with us is backed by a Robust and experienced Equity Research team which provided Free comprehensive Reports to make smart investments in the markets. We strongly focus on making Equity Trading easy and fast for you to experience its benefits; to this end we have our own proprietary trading platform .</p>
          </div>
        </div>
        <div>
        </div>
        <h2 className="pagesubtitle">
          8 Reasons to begin Trading with MegaCapital Traders Broking in
          Commodity Markets
        </h2>
        <FeaturesGrid />
      </div>
      <div className={styles.cont2}>
        <FeaturesCards title1={"Why Equity Trading with MegaCapital Traders?"} />
      </div>
